  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_LOWER_THAN_ELSE = 3,                   // LOWER_THAN_ELSE
        S_INT = 4,                               // INT
        S_ID = 5,                                // ID
        S_STRING = 6,                            // STRING
        S_IF = 7,                                // IF
        ...
        S_WHILE = 9,                             // WHILE
        S_PRINT = 10,                            // PRINT
        S_INT_TYPE = 11,                         // INT_TYPE
        S_STRING_TYPE = 12,                      // STRING_TYPE
        S_AND = 13,                              // AND
        S_OR = 14,                               // OR
        S_NOT = 15,                              // NOT
        S_EQ = 16,                               // EQ
        ...
        S_stmt_list = 35,                        // stmt_list
        S_stmt = 36,                             // stmt
        S_simple_stmt = 37,                      // simple_stmt
        S_block_stmt = 38,                       // block_stmt
        S_expr = 39                              // expr
      };
    };
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, ASTPtr&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const ASTPtr& v)
        : Base (t)
        , value (v)
      {}
#endif
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      make_STRING_TYPE ()
      {
        return symbol_type (token::STRING_TYPE);
      }
#else
      static
      symbol_type
